...
BEGIN
  ...
  INSERT INTO public.settings (guild_id, key, value_json) VALUES
    ...
    (p_guild_id, 'auto_quiz', '{"enabled": false, "channel_id": null, "questions_per_round": 5, "seconds_per_question": 20, "reward_per_correct": 10, "category": null, "bonus_enabled": true, "auto_generate": true, "language": "English", "daily_times_utc": ["18:00", "00:00"], "topics": ["cinema", "music", "Cronos blockchain", "Loaded Lions Mane City", "general knowledge"]}'::jsonb)
